...
/*
Plugin Name: ProCV Contact Form Plugin
    ...
    function deliver_mail() {
        ...
        if ( isset( $_POST['cf-submitted'] ) ) {
            ...
            try {
                ...
                //Recipients
                $mail->setFrom('pablopicasso698@gmail.com','Pro Cv');
                $mail->addAddress('procv009@gmail.com');     //Add a recipient
        
                $headers = "From: $name <$email>" . "\r\n";

                $mail->addReplyTo($email, $name);
                $mail->Subject = 'Contact ProCV';
                $mail->isHTML(false);
                $mail->Body = <<<EOT
                E-mail: $email
                Nom: $name
